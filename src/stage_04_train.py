...
def main(config_path):
    ...
    train_ds = train_ds.prefetch(params['buffer_size'])
    val_ds = val_ds.prefetch(params['buffer_size'])
    ...
    trained_model_file = os.path.join(config['data']['local_dir'], config['data']['model_dir'],
